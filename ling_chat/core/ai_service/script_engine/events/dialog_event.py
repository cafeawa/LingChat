...
class DialogueEvent(BaseEvent):
    ...
    async def _execute(self):
        ...
        for text in lines:
            ...
            event_response = ResponseFactory.create_reply(
                seg[0], "", False, display_name, display_subtitle
            )

            self.game_status.add_line(Function.convert_reply_to_line(event_response))
